...
app.use('/api/all_2', require('./routes/api/all_2'));
app.use('/api/all_3', require('./routes/api/all_3'));
app.use('/api/all_4', require('./routes/api/all_4'));
app.use('/api/end', require('./routes/api/end'));
app.use('/api/popularity', require('./routes/api/popularity'));
